      ...
      <div className="max-w-4xl w-full mx-auto px-4 py-6">
        ...
        {activeTab === 'punch' && (
          <div className="max-w-md mx-auto space-y-4 animate-in fade-in duration-200">
            ...
            {/* ⭐ LEAVE A STUDENT REVIEW BANNER WITH ANIMATED GLOW */}
            <div 
              onClick={() => window.open('https://sudhirkr85.github.io/review/', '_blank')}
              className="bg-gradient-to-r from-[#FFF8E7] via-[#FFF3D6] to-[#FFE8B3] border-2 border-[#FF9500]/40 rounded-2xl p-4 shadow-md flex items-center justify-between cursor-pointer hover:border-[#FF9500] hover:shadow-lg transition-all group relative overflow-hidden"
            >
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-2xl bg-[#FF9500] text-white shadow-lg shadow-[#FF9500]/30 group-hover:scale-110 transition-transform flex items-center justify-center shrink-0 relative">
                ...
                <div className="text-left">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <span className="text-[10px] font-extrabold bg-[#FF9500] text-white px-2.5 py-0.5 rounded-full shadow-2xs animate-bounce">⭐ 5.0 Star</span>
                  </div>
              ...
              <ExternalLink className="w-4 h-4 text-[#FF9500] shrink-0 ml-2 group-hover:translate-x-1 transition-transform" />
            </div>

            {/* 🌐 OFFICIAL FOLLOW US SOCIAL HUB (4 ANIMATED CARDS) */}
            <div className="space-y-2 pt-1">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="text-[10px] font-bold text-[#0071E3] flex items-center gap-1">
                  <span className="w-2 h-2 rounded-full bg-[#34C759] animate-ping inline-block"></span>
                  @sssamacademy
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div 
                  ...
                  className="bg-white p-3 rounded-2xl border border-[#E5E5EA] shadow-2xs flex items-center justify-between cursor-pointer hover:border-[#34C759] hover:shadow-sm transition-all group"
                >
                  <div className="flex items-center gap-2.5 text-left">
                    <div className="p-2 rounded-xl bg-[#E8F8EE] text-[#34C759] group-hover:scale-110 transition-transform flex items-center justify-center shrink-0 relative">
                      <MessageSquare className="w-4 h-4" />
                      <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-[#34C759] rounded-full animate-ping"></span>
                    </div>
                    <div>
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-[#34C759] shrink-0 group-hover:translate-x-0.5 transition-transform" />
                </div>

                {/* 🔴 YouTube CodingWithSudhir */}
                <div 
                  onClick={() => window.open('https://www.youtube.com/@CodingWithSudhir', '_blank')}
                  className="bg-white p-3 rounded-2xl border border-[#E5E5EA] shadow-2xs flex items-center justify-between cursor-pointer hover:border-[#FF0000] hover:shadow-sm transition-all group"
                >
                  <div className="flex items-center gap-2.5 text-left">
                    <div className="p-2 rounded-xl bg-[#FFF0F0] text-[#FF0000] group-hover:scale-110 transition-transform flex items-center justify-center shrink-0 relative">
                      ...
                      <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-[#FF0000] rounded-full animate-ping"></span>
                    </div>
                    <div>
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-[#FF0000] shrink-0 group-hover:translate-x-0.5 transition-transform" />
                </div>

                {/* 📸 Instagram Page */}
                <div 
                  onClick={() => window.open('https://www.instagram.com/sssamacademy', '_blank')}
                  className="bg-white p-3 rounded-2xl border border-[#E5E5EA] shadow-2xs flex items-center justify-between cursor-pointer hover:border-[#E1306C] hover:shadow-sm transition-all group"
                >
                  <div className="flex items-center gap-2.5 text-left">
                    <div className="p-2 rounded-xl bg-[#FFF0F6] text-[#E1306C] group-hover:scale-110 transition-transform flex items-center justify-center shrink-0 relative">
                      <svg className="w-4 h-4 animate-pulse" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-[#E1306C] rounded-full animate-ping"></span>
                    </div>
                    <div>
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-[#E1306C] shrink-0 group-hover:translate-x-0.5 transition-transform" />
                </div>

                {/* 💼 LinkedIn Page */}
                <div 
                  onClick={() => window.open('https://www.linkedin.com/company/sssamacademy', '_blank')}
                  className="bg-white p-3 rounded-2xl border border-[#E5E5EA] shadow-2xs flex items-center justify-between cursor-pointer hover:border-[#0A66C2] hover:shadow-sm transition-all group"
                >
                  <div className="flex items-center gap-2.5 text-left">
                    <div className="p-2 rounded-xl bg-[#E8F2FF] text-[#0A66C2] group-hover:scale-110 transition-transform flex items-center justify-center shrink-0 relative">
                      <svg className="w-4 h-4 animate-pulse" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                      </svg>
                      <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-[#0A66C2] rounded-full animate-ping"></span>
                    </div>
                    <div>
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-[#0A66C2] shrink-0 group-hover:translate-x-0.5 transition-transform" />
                </div>
              </div>
            </div>
